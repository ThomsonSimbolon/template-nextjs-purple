...
export function StatCard({ title, value, change, icon: Icon, trend = 'up' }: StatCardProps) {
  ...
  return (
    <div className="group bg-surface rounded-xl p-8 border border-primary/20 hover:border-primary/50 transition-all duration-200 hover:shadow-glow min-h-[180px] flex flex-col justify-between">
